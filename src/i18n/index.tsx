...
const catalan = {
  ...
  saved_data_sources: 'Fonts de dades',
  saved_powered_by_tram: 'Powered by TRAM Barcelona',
...
const spanish: Translations = {
  ...
  saved_title: 'Tú', saved_subtitle: 'Tus rutas y paradas habituales.', saved_places: 'Lugares guardados', saved_home: 'Casa', saved_work: 'Trabajo', saved_set_place: 'Configurar en el mapa', saved_edit_place: 'Editar en el mapa', saved_plan_from: 'Planificar desde aquí', saved_favorite_stops: 'Paradas favoritas', saved_favorite_lines: 'Líneas favoritas', saved_recent: 'Reciente', saved_empty_favorites: 'Aún no tienes favoritos.', saved_empty_recent: 'Las paradas y rutas que consultes aparecerán aquí.', saved_preferences: 'Preferencias', saved_language: 'Idioma', saved_theme: 'Apariencia', saved_data_sources: 'Fuentes de datos', saved_powered_by_tram: 'Powered by TRAM Barcelona', theme_system: 'Sistema', theme_light: 'Claro', theme_dark: 'Oscuro', saved_clear_data: 'Borrar favoritos e historial', saved_clear_data_title: '¿Borrar favoritos e historial?', saved_clear_data_body: 'Se eliminarán las líneas, paradas y rutas recientes guardadas.', saved_cancel: 'Cancelar', saved_delete: 'Borrar', saved_remove: 'Eliminar', saved_station: 'Parada', saved_route: 'Ruta',
