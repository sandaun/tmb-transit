...
const spanish: Translations = {
  ...
  lines_title: 'Líneas', lines_subtitle: 'Elige una línea para ver sus estaciones.', metro: 'Metro', bus: 'Bus', fgc: 'FGC', lines_search: 'Buscar línea', lines_search_bus: 'Buscar línea o destino', lines_all: 'Todas', lines_loading: 'Cargando líneas…', lines_empty: 'No hay líneas que coincidan.', lines_load_error: 'No se han podido cargar las líneas.', line_accessibility: 'Línea {code}', line_favorite: 'Añadir línea a favoritos', line_unfavorite: 'Eliminar línea de favoritos', station_search: 'Buscar parada', stations_load_error: 'No se han podido cargar las estaciones.', stations_loading: 'Cargando paradas…', stations_empty: 'No hay paradas que mostrar.',
