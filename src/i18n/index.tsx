...
const spanish: Translations = {
  ...
  saved_title: 'Tú', saved_subtitle: 'Tus rutas y paradas habituales.', saved_places: 'Lugares guardados', saved_home: 'Casa', saved_work: 'Trabajo', saved_set_place: 'Configurar en el mapa', saved_edit_place: 'Editar en el mapa', saved_plan_from: 'Planificar desde aquí', saved_favorite_stops: 'Paradas favoritas', saved_favorite_lines: 'Líneas favoritas', saved_recent: 'Reciente', saved_empty_favorites: 'Aún no tienes favoritos.', saved_empty_recent: 'Las paradas y rutas que consultes aparecerán aquí.', saved_preferences: 'Preferencias', saved_language: 'Idioma', saved_theme: 'Apariencia', theme_system: 'Sistema', theme_light: 'Claro', theme_dark: 'Oscuro', saved_clear_data: 'Borrar favoritos e historial', saved_clear_data_title: '¿Borrar favoritos e historial?', saved_clear_data_body: 'Se eliminarán las líneas, paradas y rutas recientes guardadas.', saved_cancel: 'Cancelar', saved_delete: 'Borrar', saved_remove: 'Eliminar', saved_station: 'Parada', saved_route: 'Ruta',
  ...
  lines_title: 'Líneas', lines_subtitle: 'Elige una línea para ver sus estaciones.', metro: 'Metro', bus: 'Bus', fgc: 'FGC', lines_search: 'Buscar línea', lines_search_bus: 'Buscar línea o destino', lines_all: 'Todas', lines_loading: 'Cargando líneas…', lines_empty: 'No hay líneas que coincidan.', lines_load_error: 'No se han podido cargar las líneas.', line_accessibility: 'Línea {code}', line_no_service_today: 'Sin servicio hoy', line_favorite: 'Añadir línea a favoritos', line_unfavorite: 'Eliminar línea de favoritos', station_search: 'Buscar parada', stations_load_error: 'No se han podido cargar las estaciones.', stations_loading: 'Cargando paradas…', stations_empty: 'No hay paradas que mostrar.',
  alerts_title: 'Alertas', alerts_network: 'Red TMB + FGC', alerts_all: 'Todas', alerts_now: 'Ahora', alerts_planned: 'Planificado', alerts_mine: 'Mías', alerts_one: 'aviso', alerts_other: 'avisos', alerts_summary: '{current} ahora · {planned} planificados', alerts_load_error: 'No se han podido actualizar las alertas.', alerts_loading: 'Cargando alertas…', alerts_empty_title: 'No hay alertas con estos filtros.', alerts_empty_body: 'El servicio no tiene avisos publicados ahora mismo.', alert_disruption: 'Incidencia', alert_warning: 'Aviso', alert_info: 'Info', alert_metro_bus: 'Metro + Bus',
